...
from data_process.process_dm_regression import ProcessCheBIDM
from model.QA_trainer import QA_Trainer
...
def main(args):
    ...
    dm = ProcessCheBIDM(args.mode, args.num_workers, args.batch_size, args.root, args.text_max_len, tokenizer,
                       args)
    callbacks = []
